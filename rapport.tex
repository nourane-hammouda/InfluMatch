...
\begin{titlepage}
    ...
    \vspace*{1cm}
    \includegraphics[width=0.4\textwidth]{UPN.svg}
    \vspace{1.5cm}
    ...
    \vspace{1.5cm}
    {\large 
    \href{https://github.com/nourane-hammouda/InfluMatch}{https://github.com/nourane-hammouda/InfluMatch}
    \par}
    \vfill
\end{titlepage}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item \texttt{index.css} : Fichier CSS principal importe Bootstrap et styles personnalisés
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Bootstrap 5 avec React Bootstrap} : Framework CSS utilisé exclusivement pour le styling, permettant un développement rapide d'interfaces responsive avec des composants React pré-construits
\end{itemize}
